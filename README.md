...
| Metric | Paper | Ours V1 (stride=10, t=0.9) | Δ (V1 vs Paper) | **Ours V2** | **Δ (V2 vs Paper)** | **Δ (V2 vs V1)** |
|---|---|---|---|---|---|---|
| Precision | 0.872 | **0.9855** | +0.114 | - | - | - |
| Recall | **0.750** | 0.6926 | −0.057 | - | - | - |
| Dice | 0.744 | 0.8135 | +0.070 | **0.8298** | **+0.086** | **+0.016** |
| **UAV IoU (per-image avg)** ≡ paper "mIoU" | 0.646 | 0.6849 | +0.039 | **0.7740** | **+0.128** | **+0.089** |
| Pixel Accuracy | - | - | - | **0.9994** | - | - |
| Inference Time | - | - | - | **0.91 ms** | - | - |
